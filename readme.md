...
* **Liam Sorta** - Liam works closely with the Hackathon community, running a UK-based event for ~200 developers annually, to help educate new and experienced developers. He also created an [Alexa-driven VR Adventure Game](https://www.youtube.com/watch?v=QMQq7hCe-kg) He now runs [Voice.tv](https://voice.tv), an Alexa community focused on voice education and research, with a foucs on democratising voice for new developers. [Twitter](https://twitter.com/LiamSorta) [LinkedIn](https://www.linkedin.com/in/liamsorta)
...
* [Unofficial Alexa Discord](https://discord.gg/asAH2wk) - Offering support on Alexa development, marketing and networking opportunities for voice development agencies.
